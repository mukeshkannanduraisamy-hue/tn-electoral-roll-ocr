...
def test_s2_is_a_shift_recorded_in_the_second_supplement():
    """The letter carries the reason, the digit the supplement.

    Legend on the roll's last page: `S- Shifted`. Its summary declares 7
    deletions in supplement 2, and exactly 7 cards read `S2`.
    """
